...
public class AudioWaveformCreator {
    ...
    public AudioWaveformCreator(File url, String waveformFilename) throws Exception {
        if (url != null) {
            try {
                errStr = null;
...
//        URL url = new URL("http://pscode.org/media/leftright.wav");
        File url = new File("D:\\work\\project\\MusicMoodDetection-classical\\MusicMoodDetection-Classical\\dataset\\new dataset\\Adbhuta\\Bada Khyal - Harwa Goondh Laao - Ektal Vilambit - PVR.mp3");
