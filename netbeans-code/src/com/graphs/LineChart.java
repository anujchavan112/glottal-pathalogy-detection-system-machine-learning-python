...
//            ChartUtilities.writeChartAsPNG(out, chart, c.getWidth(), c.getHeight());
    ...
    public static BufferedImage getLineChartMFCC() {
        ArrayList<double[]> arr = FileHelper.parseFileDouble(ServerConstants.PROJECT_DIR + "training.csv");
        ChartModel c = new ChartModel();
        c.width = 700;
        c.height = 400;
...
//       ArrayList<String>  columnLabels = (ArrayList<String>) FileObjectHelper.readObject("columnsKey.bin");
